...
class Window(QWidget):
    ...
    def Repeated_Operation_Error(self,Function):
        ...
        for index in range(0, len(Function)):
            if "**" in Function[index] or "//" in Function[index] or "^^" in Function[index] or Function[index] == "":
    ...
    def Checking_For_Errors(self,Function, Max_Value, Min_Value):
        ...
        if UnIdentified_Error[0]:
            ...
            if Numb_Vari_Error[0]:
                ...
                self.error("The Following Terms Have Numbers Followed By Variables which is not allowed  " + str(Numb_Vari_Error))
                Flag = 1
            ...
            if Rep_Op_Error[0]:
                ...
                for Index in range(0, len(Rep_Op_Error)):
                    if Rep_Op_Error[Index] == "" and y == 0:
                        ...
                        y = 1
                self.error("The Following Operation and Terms have Repeated Operations " + str(Rep_Op_Error))
                Flag = 1
        return Flag
