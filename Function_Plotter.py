...
class Window(QWidget):
    ...
    def Repeated_Operation_Error(self,Function):
        ...
        for index in range(0, len(Function)):
            if "**" in Function[index] or "//" in Function[index] or "^^" in Function[index] or Function[index] == "" or "()" in Function[index] or "xx" in Function[index] or "^)" in Function[index] or "*)" in Function[index] or "/)" in Function[index]:
            ...
            if Rep_Op_Error[0]:
                ...
                for Index in range(0, len(Rep_Op_Error)):
                    if Rep_Op_Error[Index] == "" and y == 0:
                        ...
                        y = 1
                self.error("The Following Operation or Variables and Terms have Repeated Operations or Empty Brackets or Operation * or / or ^ followed by -> )" + str(Rep_Op_Error))
                Flag = 1
        return Flag
